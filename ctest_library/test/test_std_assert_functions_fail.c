...
int main(void)
{
	...
	start_suite("FAIL", "ALL tests in this suite must fail.", functions_tested);
		...
		start_module("u_iArray - permutation", "Every assert in this module must fail.", (char *[]){"assert_unsigned_integerArray_permutation", NULL});
			...
			assert_unsigned_integerArray_permutation(UI{1}, 1, UI{0, 1}, 2, __LINE__, NULL);
			...
			assert_unsigned_integerArray_permutation(UI{31, 62, 43}, 3, UI{8, 900, 5, 4}, 4, __LINE__, NULL);
			assert_unsigned_integerArray_permutation(UI{318, 3889262, 843}, 3, UI{838992, 900, 8, 3889262, 32, 5, 4}, 7, __LINE__, NULL);
			assert_unsigned_integerArray_permutation(UI{12333341, 8, 1279982, 2772, 9902}, 5, UI{1279982, 12333341, 3, 2772, 9902, 8}, 6, __LINE__, NULL);
		...
		//----------------------assert_unsigned_integerArray_isPartialPermutation-------------------------
		//Tests that will fail:
		start_module("u_iArray - isPartialPermutation", "Every assert in this module must fail.", (char *[]){"assert_unsigned_integerArray_isPartialPermutation", NULL});
			verbose = LOW;
			assert_unsigned_integerArray_isPartialPermutation(UI{1}, 1, UI{0}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 1, 4}, 3, UI{1, 3, 1}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{31, 62, 43}, 3, UI{8, 900, 5, 4}, 4, __LINE__, NULL);
			...
			verbose = HIGH;
			assert_unsigned_integerArray_isPartialPermutation(UI{1}, 1, UI{0}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 0}, 2, UI{1, 1, 2}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{0, 0}, 2, UI{1, 1}, 2, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 2, 3}, 3, UI{1, 1, 3}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 1, 4}, 3, UI{1, 3, 1}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 1, 4}, 3, UI{1, 1}, 2, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 2, 3}, 3, UI{3, 1, 1}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 2, 3, 4, 5}, 5, UI{32, 45, 32, 56, 93}, 5, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1}, 1, UI{0, 9}, 2, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 0}, 2, UI{0}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{1, 2, 3}, 3, UI{1, 1, 90, 2}, 4, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{31, 62, 43}, 3, UI{8, 900, 5, 4}, 4, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{318, 3889262, 843}, 3, UI{838992, 900, 8, 3889262, 32, 5, 4}, 7, __LINE__, NULL);
			assert_unsigned_integerArray_isPartialPermutation(UI{12333341, 98, 1279982, 2772, 9902}, 5, UI{1279982, 12333341, 3, 2772, 9902, 8}, 6, __LINE__, NULL);
		...
		//----------------------------------------------------------------------------
		//Tests that will fail:
		start_module("uiArray-notIsPartialPermutation", "Every assert in this module must fail.", (char *[]){"assert_unsigned_integerArray_notIsPartialPermutation", NULL});
			verbose = LOW;
			assert_unsigned_integerArray_notIsPartialPermutation(UI{1}, 1, UI{1}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{1, 0}, 2, UI{1, 0}, 2, __LINE__, NULL);
			...
			assert_unsigned_integerArray_notIsPartialPermutation(UI{1}, 1, UI{1}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{1, 0}, 2, UI{1, 0}, 2, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{1, 0}, 2, UI{0, 8, 4, 1}, 4, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{100, 100}, 2, UI{100, 100, 5}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{1, 2, 3}, 3, UI{2, 3, 1}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{1, 2, 1}, 3, UI{12, 2, 1, 1}, 4, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{11, 52, 1, 0, 0}, 5, UI{0, 1, 1, 11, 0, 52}, 6, __LINE__, NULL);
			assert_unsigned_integerArray_notIsPartialPermutation(UI{11, 52, 0, 0, 0}, 5, UI{0, 0, 11, 11, 0, 52}, 6, __LINE__, NULL);
		...
		start_module("u_iArray - setEqual", "Every assert in this module must fail.", (char *[]){"assert_unsigned_integerArray_setEqual", NULL});
			...
			assert_unsigned_integerArray_setEqual(UI{1, 1, 4}, 3, UI{1, 3, 1}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{31, 62, 43}, 3, UI{8, 900, 5, 4}, 4, __LINE__, NULL);
			...
			verbose = HIGH;
			assert_unsigned_integerArray_setEqual(UI{1}, 1, UI{0}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 1}, 2, UI{0}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 2}, 2, UI{1}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1}, 2, UI{0, 0}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1}, 2, UI{1, 0}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 0}, 2, UI{1, 1, 2}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{0, 0}, 2, UI{1, 1}, 2, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 2, 3}, 3, UI{1, 1, 3}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 1, 4}, 3, UI{1, 3, 1}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 1}, 2, UI{1, 1, 4}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 2, 3}, 3, UI{3, 1, 1}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 2, 3, 4, 5}, 5, UI{32, 45, 32, 56, 93}, 5, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{0, 9}, 2, UI{1}, 1, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{0}, 1, UI{1, 0}, 2, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1, 2, 3}, 3, UI{1, 1, 90, 2}, 4, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{8, 900, 5, 4}, 4, UI{31, 62, 43}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{838992, 900, 8, 3889262, 32, 5, 4}, 7, UI{318, 3889262, 843}, 3, __LINE__, NULL);
			assert_unsigned_integerArray_setEqual(UI{1279982, 12333341, 3, 2772, 9902, 8}, 6, UI{12333341, 98, 1279982, 2772, 9902}, 5, __LINE__, NULL);
        ...
        */
		...
		//----------------------------------------------------------------------------
		//Tests that will fail:
		start_module("string - Equal", "Every assert in this module must fail.", (char *[]){"assert_string_equal", NULL});
            char my_str[] = "!@#%$", *my_str_pointer = "\n\n\n";
			verbose = LOW;
			assert_string_equal(my_str, "!@#%4", false, __LINE__, NULL);
			...
			verbose = HIGH;
			assert_string_equal(my_str, "!@#%4", false, __LINE__, NULL);
			assert_string_equal(my_str_pointer, "\nk\n", true, __LINE__, NULL);
			assert_string_equal("", "A", true, __LINE__, NULL);
			assert_string_equal(" ", "  ", true, __LINE__, NULL);
			assert_string_equal("a", "A", false, __LINE__, NULL);
			assert_string_equal("ba\t", "bA\b", true, __LINE__, NULL);
			assert_string_equal("This is a text.\nHello world.", "this is a txt.\nHello world.", true, __LINE__, NULL);
